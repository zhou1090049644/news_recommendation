...
# 基于“用户-文章二部图”的召回
# 如果文章 A 和文章 B 被很多相同用户点击过，它们就有关系；但这个关系会被两个因素惩罚：
# 1. 点击文章 A 的用户越多，A 越热门，贡献越低
# 2. 某个用户点击文章越多，这个用户的共现贡献越低
...
def cal_sim(df):
    ...
    # 计算“文章 item 和其他文章 relate_item 的相似度
...
if __name__ == '__main__':
    ...
    sim_pkl_file = f'../user_data/sim/{mode_dir}/binetwork_sim.pkl'
    ...
    # 保存召回结果
    df_data.to_pickle(f'../user_data/data/{mode_dir}/recall_binetwork.pkl')
