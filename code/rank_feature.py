...
from utils import Logger, get_mode_dir
...
if __name__ == '__main__':
    ...
    df_feature = pd.read_pickle(f'../user_data/data/{mode_dir}/recall.pkl')
    ...
    f = open(f'../user_data/sim/{mode_dir}/itemcf_sim.pkl', 'rb')
    ...
    ## binetwork 相关
    f = open(f'../user_data/sim/{mode_dir}/binetwork_sim.pkl', 'rb')
    ...
    ## w2v 相关
    f = open(f'../user_data/data/{mode_dir}/article_w2v.pkl', 'rb')
    ...
    # 保存特征文件
    df_feature.to_pickle(f'../user_data/data/{mode_dir}/feature.pkl')
